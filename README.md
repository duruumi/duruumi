...
| 프로젝트명 | 설명 | 역할 | 형태 |
|---------|-----|-----|-----|
|SQL 데이터베이스를 이용한 쇼핑몰|SQL 데이터베이스를 활용하여 웹 사이트 쇼핑몰 제작|프론트엔드, 서버|-----|
|Flutter를 이용한 약 사진 찾기 어플리케이션|PyTorch에 알약 사진 데이터를 학습시켜 사진으로 서치| 개인 제작 |-----|
|서울시 데이터를 이용한 재난지도|서울시 API를 활용하여 재난문자를 이용한 대피소를 찾을 수 있는 지도|API 가공|-----|
|유니티를 이용한 VR 리듬 FPS 게임|유니티를 사용하여 리듬에 맞추어 총을 쏘는 FPS 게임|개인 제작|-----|
|유니티를 이용한 2D FPS 게임|2D 횡스크롤 게임으로 마우스 방향에 따라 총이 나가는 FPS 게임|개인 제작|-----|
